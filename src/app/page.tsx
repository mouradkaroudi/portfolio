...
export default function Home() {
  return (
    <>
      ...
      <div className="px-4">
        <div className="border border-stone-800 flex  justify-between p-4 rounded-2xl max-w-[864px] mx-auto">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <ul className="list-none flex gap-2 text-stone-400 text-sm font-medium leading-4">
          ...
          <div className="flex gap-3 items-end">
            ...
            <button className="flex items-center justify-center border border-white border-opacity-[0.12] w-7 h-7 rounded-lg bg-white bg-opacity-[0.12] hover:bg-opacity-[0.20]">
      ...
      <div className="px-4">
        <div className="max-w-[798px] mx-auto">
          ...
          <div className="py-10 md:py-16"></div>
          <div className="border-t-2 border-white border-opacity-[0.12]"></div>
          <div className="py-10 md:py-16"></div>
          <BlogList />
          <div className="py-8"></div>
          <footer className="py-10 border-t border-white border-opacity-[0.12]">
